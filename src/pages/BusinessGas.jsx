...
business gas procurement and management
                    ...
                    <h2 className="text-4xl font-bold mt-2 text-gray-600 text-center">
                        ...
                        <span className="text-gray-500"> We manage the whole process so you can focus on your business and customers instead of being tied up with gas tariffs and paperwork.</span>
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                    ...
                    <div className="flex flex-col md:col-span-2 ml-10">
                        <div className="flex items-center mb-4">
                            ...
                            <span className="text-red-600"> trusted suppliers </span><span className="text-gray-500"></span>to help find you the best business gas rates.
                            </p>
                        </div>
                    </div>
    ...
    <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div className="bg-white p-6 rounded shadow-md flex flex-col transition-transform duration-300 transform hover:scale-105 hover:shadow-xl cursor-pointer">
                ...
                <h3 className="text-gray-600 font-semibold text-2xl">Gas Procurement</h3>
